...
-- Apply AFTER the first `prisma migrate dev`:
--   pnpm --filter @aq/db exec prisma migrate dev --create-only --name rls
--   → paste this file into the generated migration.sql → pnpm --filter @aq/db migrate:dev
--
-- Notes:
